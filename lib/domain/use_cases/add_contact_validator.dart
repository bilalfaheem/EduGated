...
class AddContactValidator {
  ...
  Either<AddContactFailure, Map<String, String>>  validate(AddContact addContact) {
    if (validator.validateFullName(addContact.name) == null) {
      ...
      return left(AddContactFailure(
          error: validator.validate(addContact.type, "Type")!));
    } else if (validator.validate(addContact.type, "Cnic Image") == null) {
      return left(AddContactFailure(
          error: validator.validate(addContact.type, "Cnic Image")!));
    } else {
      return right({
        "user_id": "",
